...
var presentationTimer = window.presentationTimer || {};
...
function handleDomLoaded() {
  ...
  if (slidesConfig.info.ga_account) {
...
window.slides.util = window.slides.util || {};

window.slides.util.hide = function(selector) {
...
window.slides.util.unhide = function(selector) {
  var el = document.querySelector(selector);
  if (el) {
...
window.presentationTimer = function(startTime, presLength, warnAt) {
  var insertElement, timerTick, drawClock, showClock, toRadians;
